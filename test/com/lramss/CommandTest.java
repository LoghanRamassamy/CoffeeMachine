...
class CommandTest {
    ...
    @Test
    void drinkTypeIsTea() {
        assertEquals(new Command(Drink.TEA,0.20,0).getDrink().name, "Tea");
    }

    @Test
    void drinkTeaPriceIs40() {
        assertEquals(new Command(Drink.TEA,0.20,0).getDrink().price, 0.40);
    }

    @Test
    void drinkHotCoffeePriceIs60() {
        assertEquals(new Command(Drink.HOT_COFFEE,0.30,0).getDrink().price, 0.60);
    }

    @Test
    void drinkHotChocolateEnough50() {
        assertEquals(new Command(Drink.HOT_CHOCOLATE,1.0,0).checkMoney(), 0.50);
    }
    ...
    void totalSoldDrinkWithOneValidCommand() {
        ...
        list.add(new Command(Drink.COFFEE,0.2,0));
        ...
        assertEquals(commandList.getTotalCommandSold(), 0.5);
    }
    ...
    void totalSoldDrinkWithNotValidCommand() {
        ...
        assertEquals(commandList.getTotalCommandSold(), 0.0);
    }

    @Test
    void totalSoldDrinkWithAllValidCommand() {
        List<Command> list = new ArrayList<>();
        list.add(new Command(Drink.COFFEE,0.6,0));
        ...
        assertEquals(commandList.getTotalCommandSold(), 2.1);
    }
